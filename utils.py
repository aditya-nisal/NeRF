...
def QueryPointsFromRays(ray_origins, ray_directions, near_plane, far_plane, num_samples, randomize=True):
    """
    Takes:
    Ray_origins: Origin of each ray in the "bundle" as returned by the `get_ray_bundle()` method.
    Ray_directions: Direction of each ray in the "bundle" as returned by the `get_ray_bundle()` method.
